...
import 'package:gemini/pages/classes/practice-log/practice-log.dart';
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: Text("Our Bodies and Inflammation",
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                        onTap: () {
                          var cId=isVarEmpty(widget.classId);                              
                            ...
                            children: [
                              CircularStepProgressIndicator(
                                ...
                                child: Padding(
                                  ...
                                  child: SvgPicture.asset("assets/images/icons/classes-icon/learning-icon/learning.svg",
                                  width: 18,height: 18),
                                ),
                                selectedStepSize: 3,
                              ...
                              Container(
                                margin: const EdgeInsets.fromLTRB(10, 5, 10, 17),
                                child: Container(
                      ...
                      InkWell(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              margin: const EdgeInsets.fromLTRB(10, 5, 10, 16),
                              child: Container(
                                width: 64,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: AppColors.DEEP_GREEN, width: 1)),
                  child: TabBar(
                    ...
                    tabs: [
                      Tab(
                        child: Container(
                            child: Center(
                                child: Text("To Do’s",
                                    style: AppCss.font12semibold))),
                      ),
                      Tab(
                        child: Container(
                            child: Center(
                                child: Text("Practice log",
                                    style: AppCss.font12semibold))),
                      ),
                    ],
                  ),
                  ...
                  child: Container(
                    ...
                    child: TabBarView(
                      ...
                      children: [
                        ...
                        PracticeLogTab(classId: widget.classId)
                      ],
                    ),
                  ),
                ),
