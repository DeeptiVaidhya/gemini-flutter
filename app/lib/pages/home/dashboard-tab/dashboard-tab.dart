     ...
     if ((data["data"]?.isNotEmpty ?? true)) {
      if (data['status'] == "success" ) {      
        setState(() {
          ...
          practiceList = data['data']['current_class_detail']['class_activity']['practices'];
          ...
          classDescription = data['data']['current_class_detail']['description'];	
          totalParticipant = data['data']['group_detail']['total_participants'];
                    ...
                    child: Center(
                      child: Container(                      
                        ...
                        Padding(
                          ...
                          child: (storage.getItem('name') != null) ? Text('Welcome back, ' +storage.getItem('name') +'!', style: AppCss.blue20semibold) : Text('Welcome back,',style: AppCss.blue20semibold),
                        ),
                        Container(
                          margin: const EdgeInsets.only(left: 25.0, right: 24.0,bottom: 11), 
                          child: Text.rich(
                            TextSpan(
                              ...
                              children: <InlineSpan>[
                                ...
                                TextSpan(
                                  ...
                                  TextSpan(
                                  text: "activities to finish for previous classes. See ",
                                  style: AppCss.grey12regular,
                                ),
                                WidgetSpan(
                                  child: Container(
                                  ...
                                  child: Icon(GeminiIcon.icon_exclamation,size: 9, color: AppColors.PRIMARY_COLOR),
                                  )        
                                ),
                                TextSpan(
                                  text: " below.",
                      ...
                      :
                        Align(
                          ...
                          child: Container(
                            ...
                            child: ListView.builder(
                              scrollDirection: Axis.horizontal,
                                itemCount: classList.length, itemBuilder: (context, index) {
                                  return Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: <Widget>[
                                    Stack(
                                    children: <Widget>[
                                      (classList[index]['class_status'] == "complete") ? 
                                      Center(
                                      child: InkWell(
                                        onTap: () {
                                          var classId = isVarEmpty(classList[index]['class_id']);  
                                          var week = isVarEmpty(classList[index]['week_number']);                 
                                          var url="class-details/$classId";                              
                                          Navigator.of(context).pushReplacement(
                                            new MaterialPageRoute( 
                                            settings:  RouteSettings(name:url),
                                            builder: (context) => new ClasseDetails(
                                              classId : classId,weekNumber : week,
                                              ) 
                                            )
                                          ); 
                                        }, 
                                        child: Container(
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                Text(isVarEmpty(classList[index]['week_number']).toString(),style: AppCss.white26bold,textAlign: TextAlign.center)
                                              ],
                                            )),
                                      ),
                                      ) :
                                      ((classList[index]['class_status'] == "lock") ?
                                      Opacity(
                                        opacity: 0.5,
                                        child: Container(
                                          margin: const EdgeInsets.only(right: 10),
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              style: AppCss.green19bold,textAlign: TextAlign.center)
                                            ],
                                        )
                                        ),
                                      )
                        ...
                        Padding(
                          padding: const EdgeInsets.only(top:18,left: 25, right: 24, bottom: 4),
                          child: Text('“You may not always have a comfortable life and you will not always be able to solve all of the world’s problems at once but don’t ever underestimate the importance you can have because history has shown us that courage can be contagious and hope can take on a life of its own.”',style: AppCss.blue11bolditalic,textAlign: TextAlign.center),
                        ),
                        Text('Michelle Obama',style: AppCss.blue10semibold),
                        Container(
                          ...
                          child: ClipPath(
                            ...
                            children: <Widget>[
                              ListTile(  
                                ...
                                //trailing : Text("Powered by",style: AppCss.mediumgrey6extrabold),   
                              ),
                              Container(
                              ...
                              Container(
                                ...
                                child: Text.rich(
                                  TextSpan(
                                    ...
                                    children: <InlineSpan>[
                                      TextSpan(
                                        text: isVarEmpty(leaders).toString(),
                                        style: AppCss.grey12regular,
                                      )
                                    ]
                                  )
                              ...
                              Container(
                                ...
                                child: Text.rich(
                                  TextSpan(
                                    ...
                                    children: <InlineSpan>[
                                      TextSpan(
                                        text: isVarEmpty(totalParticipant).toString(),
                                        style: AppCss.grey12regular,
                                      )
                                    ]
                                  )
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  height: 36,
                                    child: Material(
                                      shape: RoundedRectangleBorder(side: BorderSide(color: AppColors.PALE_BLUE,width: 1,style: BorderStyle.solid),
                        ...
                        Column(
                          ...
                          Container(
                            width: 500,
                            padding: EdgeInsets.only(left: 20,top: 32,bottom: 24),
                            child: Text(
                                ...
                                subtitle: Column(
                                  children: [
                                    Container(
                                      alignment: Alignment.topLeft,
                                       margin: const EdgeInsets.only(top:5,right: 10,bottom: 3),
                                      child: Text(isVarEmpty(practiceList[index]['title']).toString(),style:AppCss.blue16semibold)),
                                    Container(
                                      alignment: Alignment.topLeft,
                                      padding: const EdgeInsets.only(right: 10),
                                      child: Text(isVarEmpty(practiceList[index]['description']).toString(),style: AppCss.grey12regular),
                                    ),
                                  ],
                                ), 
                                trailing : CircularStepProgressIndicator(
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  height: 36,
                                    ...
                                    padding: const EdgeInsets.fromLTRB(1, 5, 1, 4),
                                    onPressed: () {
                                    var prId=practiceList[index]['id']!;                              
                        ...
                        Column(
                          children: [
                            Container(
                              width: 500,
                              padding: EdgeInsets.only(left: 20,top: 31,bottom: 24),
                              child: Text(
                                "Still to Do : Module 4",
                                textAlign: TextAlign.left,
                                style: AppCss.blue18semibold,
                              ),
                            ),
                            Container(
                              ...
                              child: ClipPath(
                                ...
                                ListTile( 
                                  contentPadding:EdgeInsets.only(top:10.0,left: 20.0,right: 20),                                      
                                  leading : SvgPicture.asset("assets/images/icons/journal/journal.svg",width: 43.28,height: 50.33,fit: BoxFit.fill),
                                  title : Padding(
                                    padding: const EdgeInsets.only(top:10),
                                    child: Text("Journal",style: AppCss.mediumgrey10bold),
                                  ), 
                                  subtitle: Column(
                                    children: [
                                      Container(
                                        alignment: Alignment.topLeft,
                                        padding: const EdgeInsets.only(top:1,right: 10,bottom: 3),
                                        child: Text("Reflect on Inflammation in Your Body",style:AppCss.blue16semibold)),
                                      Container(
                                        alignment: Alignment.topLeft,
                                        padding: const EdgeInsets.only(right: 10),
                                        child: Text("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed dui est, suscipit sed.",style: AppCss.grey12regular),
                                      ),
                                    ],
                                  ),  
                                  trailing : CircularStepProgressIndicator(
                                ...
                                child: Container(
                                  ...
                                  height: 36,
                                    ...
                                    textColor: AppColors.DEEP_BLUE,
                                    child: Text("Do relfection exercise".toUpperCase(),style: AppCss.blue13bold),
                                    ),
                                    ),
                                ),
                                ),                                  
