              ...
              children: <Widget>[
                Align(
                  ...
                  child: Padding(
                    ...
                    child:
                        Text("Discussion topics", style: AppCss.blue20semibold),
                  ),
                ),
                Container(
                  ...
                  child: discussionList.isEmpty
                      ? Container(
                          margin: const EdgeInsets.only(
                              top: 150, bottom: 150, left: 40, right: 40),
                          child: Text(
                            "No topics list yet.",
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            totalPost =
                                discussionList[index]['total_posts'].toString();
                            var firstPost =
                                (discussionList[index]['first_post'] != null);
                            var lastPost =
                                (discussionList[index]['last_post'] != null);
                            return Container(
                                      ...
                                      title: (discussionList[index]['title'] !=
                                          ...
                                          ? Container(
                                              margin: EdgeInsets.only(
                                                  left: 0, top: 14, right: 30),
                                              child: Text(
                                                isVarEmpty(discussionList[index]
                                                        ['title'])
                                                    .toString()
                                                    .toUpperCase(),
                                                        ...
                                                        children: <InlineSpan>[
                                                          WidgetSpan(
                                                              child: SizedBox(
                                                                  width: 3)),
                                                          TextSpan(
                                                            text: isVarEmpty(discussionList[
                                                                            index]
                                                                        [
                                                                        'first_post']
                                                                    [
