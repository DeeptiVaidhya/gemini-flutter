...
// class Item {
//   static const Newest = Item._('Newest');
//   static const Oldest = Item._('Oldest');
//   static const az = Item._('A-Z');
//   static const za = Item._('Z-A');
//   static const values = [
//     Newest,
//     Oldest,
//     az,
...
//         return List<PopupMenuEntry<Item>>.generate(Item.values.length * 2 - 1, (int index) {
//           if (index.isEven) {
//             final item = Item.values[index ~/ 2];
//             return DropdownMenuItem<Item>(value: item, text: item.text);
//           } 
//           else {
...
//         });
//       },
//       child: Text(_current == null ? 'Sort By' : _current.text,style: AppCss.blue12semibold),
//     );
//   }
// }
...
//       child: Divider(height: 0.0, color: Colors.white),
//     );
//   }
// }
...
//            padding: EdgeInsets.only(left:30,right: 50,top: 15),
...
//                     );
//                   },
//                   child: Icon(Icons.keyboard_arrow_up, size: 28.0,color: AppColors.DEEP_BLUE),
//                 ),
//               ],
//             ),
//           ),
...
// //     final RenderObject? overlay = Overlay.of(context).findRenderObject();
...
//       side: BorderSide(color: Color(0xFF3333331A), width: 1.0),
