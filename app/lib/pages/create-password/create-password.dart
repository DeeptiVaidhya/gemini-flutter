...
class CreatePassword extends StatefulWidget {
  String code;
  CreatePassword({required this.code});
  @override
...
class _CreatePasswordState extends State<CreatePassword> {
  ...
  void initState() {    
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) => checkCreatePasswordCodeData());	  
  ...
  checkCreatePasswordCodeData() async {
