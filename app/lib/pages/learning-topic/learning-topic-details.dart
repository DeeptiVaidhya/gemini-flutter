...
class __LearningTopicDetailsState extends State<LearningTopicDetails> {
  ...
  Future<void> learningTopicDetailsPost() async {
    try {
      final data = await getLearningTopicsDetailsPost(
          <String, dynamic>{"topic_id": topicId});
  ...
  Future<void> updateClass(id) async {
    try {
      final data =
          await updateClassTask(<String, dynamic>{"class_topic_id": id});
      if (data['status'] == "success") {
        Navigator.push(
          context,
          PageTransition(
            ...
            child: LearningTopic(
                key: null, classId: widget.classId, type: 'learning'),
          ),
        );
      } else {
        Navigator.of(context, rootNavigator: true).pop();
                          ...
                          child: Column(
                            children: [
                                  ...
                                  : ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        image = (detailsList[index]['image'] !=
                                                null)
                                            ? detailsList[index]['image']
                                                ['path']
                                            : '';
                                        text = (detailsList[index]['text'] !=
                                                null)
                                            ? detailsList[index]['text']['text']
                                            : '';
                                        resourcePath = (detailsList[index]
                                                    ['resource'] !=
                                                null)
                                            ? detailsList[index]['resource']
                                            : '';
                                        resourceType = (detailsList[index]
                                                    ['resource'] !=
                                                null)
                                            ? detailsList[index]['resource']
                                                ['type']
                                            : '';
                                        websiteUrl = (detailsList[index]
                                                    ['resource'] !=
                                                null)
                                            ? detailsList[index]['resource']
                                                ['path']
                                            : '';
                                        websiteTitle = (detailsList[index]
                                                    ['resource'] !=
                                                null)
                                            ? detailsList[index]['resource']
                                                ['title']
                                            : '';
                                        resourceId = (detailsList[index]
                                                    ['resource'] !=
                                                null)
                                            ? detailsList[index]['resource']
                                                ['resource_id']
                                            : '';
                                        resourceTitle = (detailsList[index]
                                                    ['resource'] !=
                                                null)
                                            ? detailsList[index]['resource']
                                                ['title']
                              ...
                              Padding(
                                ...
                                child: Text(
                                  "Have you finished reading this topic?",
                              ...
                              Container(
                                ...
                                child: Material(
                                  ...
                                  child: MaterialButton(
                                    padding:
                                        const EdgeInsets.fromLTRB(55, 9, 55, 9),
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        PageTransition(
                                          type: PageTransitionType.fade,
                                          child: ReadingFinishLater(
                                              title: widget.title),
                                        ),
                                      );
                                    },
                                    ...
                                    child: Text(
                                        "No, I will FINISH later".toUpperCase(),
