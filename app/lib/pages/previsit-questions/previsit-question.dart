...
class _PrevisitQuestion1State extends State<PrevisitQuestion1> {
  ...
  final GlobalKey<FormFieldState> _postTextFormKey =
      GlobalKey<FormFieldState>();
  final GlobalKey<FormFieldState> _postTextBox = GlobalKey<FormFieldState>();
  final GlobalKey<FormFieldState> _systolicFormKey =
      GlobalKey<FormFieldState>();
  ...
  backButton() {
    if (questionIndex != 0) {
      ...
      Navigator.pushNamed(context, '/start-previsit');
    }
  }
  ...
  submitWeeklyCheckin(id, answer) async {
    ...
    if (data['status'] == "success") {
      ...
      setState(() {
        questionIndex += 1;
        // if (questionIndex == questionSequence.last) {
        //   Navigator.pushNamed(context, '/thanks-health-check-in');
        // } else {
        //   questionIndex += 1;
        // }
  ...
  _onUpdate(String id, String value) {
    // Map<String, dynamic> json = {'id': id, 'answer': value};
    // _value.add(json);
    if (id == '31') {
      systolic = value;
    }
  ...
  Widget mutipleTextField(option, {oIndex = 0, length = 1}) {
    ...
    return option.isEmpty
        ? Container()
        : SizedBox(
            // width: (MediaQuery.of(context).size.width / length) -(oIndex < lastIndex ? 16 : 0),
                                                    ...
                                                    (optionsList[index]
                                                        ...
                                                        ? Padding(
                                                            ...
                                                            child: (!da.contains(
                                                                      ...
                                                                      child: Container(
                                                                          ...
                                                                          child: Container(
                                                                            margin: EdgeInsets.only(
                                                                                ...
                                                                                top: 19),
                                                                            child:
                                                                                Text(optionsList[index]['label'].toString(), style: AppCss.blue16semibold),
                                                                          )),
                                                                    ),
                                                                  )
                                                                ...
                                                                //     btnheight =
                                                                //         60,
                                                                //     btntext = optionsList[index]['label']
                                                                //         .toString(),
                                                                //     AppCss
                                                                //         .blue16semibold,
                                                                //     AppColors
                                                              ...
                                                              index < 1
                                                                  ? Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        height:
                                                                            44,
                                                                        child: ((systolic != '' && diastolic != '') ||
                                                                                (weight != '' && currentSelectedValue != null) ||
                                                                                _isSubmitButtonEnabledForTextBox)
                                                                            ? Material(
                                                                                ...
                                                                                child: MaterialButton(
                                                                                  ...
                                                                                  onPressed: () {
                                                                                    if (optionsList[index]['id'] == '31') {
                                                                                      submitWeeklyCheckin('31', systolic + '/' + diastolic);
                                                                                    }
                                                                                    if (optionsList[index]['id'] == '34') {
                                                                                      submitWeeklyCheckin('34', weight + '/' + currentSelectedValue);
                                                                                    } else {
                                                                                      submitWeeklyCheckin(optionsList[index]['id'], _textAreaController.text);
                                                                                    }
                                                                                    _textAreaController.clear();
